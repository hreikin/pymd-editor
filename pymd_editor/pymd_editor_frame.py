...
class EditorFrame(ttk.Frame):
    def __init__(self, master, **kwargs):
        ...
        self.open_icon = ttk.PhotoImage(file="pymd_editor/icons/round_file_open_black_24dp.png")
        self.open_btn = ttk.Button(self.top_bar, text="Open", command=self.open_md_file, image=self.open_icon)
        self.open_btn.pack(side="left", padx=0, pady=0)
        self.save_as_icon = ttk.PhotoImage(file="pymd_editor/icons/round_save_as_black_24dp.png")
        self.save_as_btn = ttk.Button(self.top_bar, text="Save As", command=self.save_as_md_file, image=self.save_as_icon)
        self.save_as_btn.pack(side="left", padx=0, pady=0)
        self.save_icon = ttk.PhotoImage(file="pymd_editor/icons/round_save_black_24dp.png")
        self.save_btn = ttk.Button(self.top_bar, text="Save", command=self.save_md_file, image=self.save_icon)
        self.save_btn.pack(side="left", padx=0, pady=0)
        self.undo_icon = ttk.PhotoImage(file="pymd_editor/icons/round_undo_black_24dp.png")
        self.undo_btn = ttk.Button(self.top_bar, text="Undo", command=lambda: self.text_area.event_generate("<<Undo>>"), image=self.undo_icon)
        self.undo_btn.pack(side="left", padx=0, pady=0)
        self.redo_icon = ttk.PhotoImage(file="pymd_editor/icons/round_redo_black_24dp.png")
        self.redo_btn = ttk.Button(self.top_bar, text="Redo", command=lambda: self.text_area.event_generate("<<Redo>>"), image=self.redo_icon)
        self.redo_btn.pack(side="left", padx=0, pady=0)
        self.cut_icon = ttk.PhotoImage(file="pymd_editor/icons/round_content_cut_black_24dp.png")
        self.cut_btn = ttk.Button(self.top_bar, text="Cut", command=lambda: self.text_area.event_generate("<<Cut>>"), image=self.cut_icon)
        self.cut_btn.pack(side="left", padx=0, pady=0)
        self.copy_icon = ttk.PhotoImage(file="pymd_editor/icons/round_file_copy_black_24dp.png")
        self.copy_btn = ttk.Button(self.top_bar, text="Copy", command=lambda: self.text_area.event_generate("<<Copy>>"), image=self.copy_icon)
        self.copy_btn.pack(side="left", padx=0, pady=0)
        self.paste_icon = ttk.PhotoImage(file="pymd_editor/icons/round_content_paste_black_24dp.png")
        self.paste_btn = ttk.Button(self.top_bar, text="Paste", command=lambda: self.text_area.event_generate("<<Paste>>"), image=self.paste_icon)
        self.paste_btn.pack(side="left", padx=0, pady=0)
        self.find_icon = ttk.PhotoImage(file="pymd_editor/icons/round_find_in_page_black_24dp.png")
        ...
        # self.strikethrough_btn = ttk.Button(self.top_bar, text="Strikethrough")
        # self.strikethrough_btn.pack(side="left", padx=0, pady=0)
        # self.unordered_list_btn = ttk.Button(self.top_bar, text="Unordered List")
        # self.unordered_list_btn.pack(side="left", padx=0, pady=0)
        # self.ordered_list_btn = ttk.Button(self.top_bar, text="Ordered List")
        # self.ordered_list_btn.pack(side="left", padx=0, pady=0)
        # self.checklist_btn = ttk.Button(self.top_bar, text="Checklist")
        # self.checklist_btn.pack(side="left", padx=0, pady=0)
        # self.blockquote_btn = ttk.Button(self.top_bar, text="Blockquote")
        # self.blockquote_btn.pack(side="left", padx=0, pady=0)
        # self.codeblock_btn = ttk.Button(self.top_bar, text="Codeblock")
        # self.codeblock_btn.pack(side="left", padx=0, pady=0)
        # self.table_btn = ttk.Button(self.top_bar, text="Table")
        # self.table_btn.pack(side="left", padx=0, pady=0)
        # self.link_btn = ttk.Button(self.top_bar, text="Link")
        ...
        self.style_menu = ttk.Menu(self.style_opt_btn, tearoff=False)
